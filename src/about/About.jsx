    ...
    return (
        ...
        <article className="cf ph3 ph5-ns pt5 pb3">
            ...
            <div className="fn fl-ns w-50-ns">
                ...
                I am a designer / front-end developer at <a className="f5 fw6 green no-underline underline-hover" href="https://rightindem.com/" target="_blank">RightIndem</a>, 
                focusing on best practice, maintainability, and bridging the gap between
                design and development.
                </p>
                <p className="f5 lh-copy measure">
                Recently I've been working on RightIndem's <a className="f5 fw6 blue no-underline underline-hover" href="https://facebook.github.io/react/" target="_blank">React.js</a> application,
                to create a re-usable UI component library.
                </p>
            </div>
        </article>
