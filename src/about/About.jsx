            ...
            <article className="cf ph3 ph5-ns pt5 pb3">
                <header className="fn fl-ns w-50-ns pr4-ns">
                    ...
                    <div className="pv2">
                        ...
                        <a className="link hover-silver near-black dib h2 w2 mr3" href="https://instagram.com/altshort" title="Instagram" target="_blank" rel="noopener noreferrer">
                ...
                <div className="fn fl-ns w-50-ns">
                    ...
                    I am a designer / front-end developer at <a className="f5 fw6 dark-green no-underline underline-hover" href="https://rightindem.com/" target="_blank" rel="noopener noreferrer">RightIndem</a>, 
                    focusing on best practice, maintainability, and bridging the gap between
                    design and development.
                    </p>
                    <p className="f5 lh-copy measure">
                    Recently I've been working on RightIndem's <a className="f5 fw6 blue no-underline underline-hover" href="https://facebook.github.io/react/" target="_blank" rel="noopener noreferrer">React</a> application,
                    creating a re-usable UI component library. The components are documented using <a className="f5 fw6 red no-underline underline-hover" href="https://getstorybook.io/" target="_blank" rel="noopener noreferrer">React Storybook </a>
                    ...
                    (this site started as a way to try <a className="f5 fw6 gray no-underline underline-hover" href="http://tachyons.io/" target="_blank" rel="noopener noreferrer">Tachyons</a>).
                    Most recently i've been using the awesome <a className="f5 fw6 green no-underline underline-hover" href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">Vue.js </a>
                    to make a webapp collating the best rhyming terms for the members of the RightIndem design team.
                    Check it out <a className="f5 fw6 green no-underline underline-hover" href="https://github.com/JonShort/DesignerRhymer" target="_blank" rel="noopener noreferrer">here</a>.
                    </p>
                    <p className="f5 lh-copy measure">
